...
PostsListController = RouteController.extend({
  ...
  category: function(){
    return  this.params.postsCategory || "postlist";
  },
  ...
  data: function() {
    ...
    var nextPath = this.route.path({postsLimit: this.limit() + this.increment,postsCategory: this.category()});
    return {
      posts: this.posts(),
